...
import { REPORT_TYPES, COST_PER_REPORT } from '../../components/generate/reports-registry';
import { useGenerateReport } from '../../components/generate/useGenerateReport';
...
export default function GeneratePage() {
  ...
  return (
    <div style={styles.page}>
      ...
      {/* Placeholder for the big builder (kept minimal per your request) */}
      <div style={styles.sectionHeader}>
